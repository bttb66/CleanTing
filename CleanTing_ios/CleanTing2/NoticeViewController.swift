...
class NoticeViewController: UIViewController{
    ...
    lazy var sections : [Notice_Expendable_Section] = {
        ...
        let section1 = Notice_Expendable_Section(title : "TING A", data: "0", expendable: true)
       
        let section2 = Notice_Expendable_Section(title: "TING B",  data: "0" , expendable: false)
        
        let section3 = Notice_Expendable_Section(title: "TING C", data: "0" , expendable: true)
